...
/**
 * Read stream date line by line.
 * 
 * @constructor
 * @param {String|ReadStream} file File path or date stream object.
 */
function LineReader(file) {
  ...
  this.remainBuffers = [];
  var self = this;
  this.readstream.on('date', function (data) {
    self.ondata(data);
  });
