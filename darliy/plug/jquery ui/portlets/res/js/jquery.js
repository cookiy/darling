...
(function(av, az){
 ...
 : function(bi){
    ...
    O.fn.extend({
            ...
            if (B && typeof B === "string" || B === az) {
                for (var c = (B || "").split(ar), U = 0, T = this.length; U < T; U++) {
                    ...
                    if (S.nodeType === 1 && S.className) {
                        if (B) {
                            for (var P = (" " + S.className + " ").replace(aO, " "), t = 0, E = c.length; t < E; t++) {
                                P = P.replace(" " + c[t] + " ", " ")
                            }
        ...
        toggleClass: function(t, c){
            ...
            return this.each(function(){
                if (E === "string") {
                    for (var U, T = 0, P = O(this), S = c, V = t.split(ar); U = V[T++];) {
                        S = B ? S : !P.hasClass(U);
    ...
    O.event = {
        ...
        special: {
            ...
            live: {
                add: function(c){
                    O.event.add(this, ag(c.origType, c.selector), O.extend({}, c, {
                        handler: z,
                        guid: c.handler.guid
                    }))
                },
 ...
 : function(t, c, B){
    ...
    (function(){
            ...
            if (a4.length > 1 && aa.exec(bb)) {
                ...
                if (ba) {
                    a5 = a8 ? {
                        expr: a4.pop(),
                        set: t(a8)
                    } : S.find(a4.pop(), a4.length === 1 && (a4[0] === "~" || a4[0] === "+") && ba.parentNode ? ba.parentNode : ba, bc);
        ...
        S.filter = function(bc, bb, a7, a8){
            for (var a6, a5, bh = bc, bg = [], bi = bb, bf = bb && bb[0] && S.isXML(bb[0]); bc && bb.length;) {
            ...
            relative: {
                "+": function(a6, a5){
                    ...
                    for (var a8 = a6.length, a7; a4 < a8; a4++) {
                        if (a7 = a6[a4]) {
                            for (; (a7 = a7.previousSibling) && a7.nodeType !== 1;) {
                            }
 ...
 : function(){
    ...
    O.fn.extend({
        ...
        empty: function(){
            for (var t = 0, c; (c = this[t]) != null; t++) {
                for (c.nodeType === 1 && O.cleanData(c.getElementsByTagName("*")); c.firstChild;) {
        ...
        domManip: function(V, U, T){
            ...
            if (this[0]) {
                S = t && t.parentNode;
                S = O.support.parentNode && S && S.nodeType === 11 && S.childNodes.length === this.length ? {
                    fragment: S
    ...
    var w = /alpha\([^)]*\)/i, aH = /opacity=([^)]*)/, aq = /-([a-z])/ig, J = /([A-Z])/g, j = /^-?\d+(?:px)?$/i, u = /^-?\d/, h = {
        ...
        visibility: "hidden",
        display: "block"
    }, ad = ["Left", "Right"], D = ["Top", "Bottom"], ai, aY, aG, aW = function(t, c){
    ...
    O.fn.offset = "getBoundingClientRect" in G.documentElement ? function(t){
        ...
        E = aU(E);
        return {
            top: S.top + (E.pageYOffset || O.support.boxModel && B.scrollTop || c.scrollTop) - (B.clientTop || c.clientTop || 0),
            left: S.left + (E.pageXOffset || O.support.boxModel && B.scrollLeft || c.scrollLeft) - (B.clientLeft || c.clientLeft || 0)
        }
    }
 : function(V){
        var U = this[0];
        ...
        for (var B = U.offsetTop, c = U.offsetLeft; (U = U.parentNode) && U !== t && U !== E;) {
    ...
    O.fn.extend({
        position: function(){
            ...
            var t = this[0], c = this.offsetParent(), E = this.offset(), B = ax.test(c[0].nodeName) ? {
                top: 0,
                left: 0
            } : c.offset();
        ...
        offsetParent: function(){
            return this.map(function(){
                for (var c = this.offsetParent || G.body; c && !ax.test(c.nodeName) && O.css(c, "position") === "static";) {
                    c = c.offsetParent
                }
                return c
            })
