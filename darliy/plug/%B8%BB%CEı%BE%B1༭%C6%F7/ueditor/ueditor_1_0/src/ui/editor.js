(function (){
    ...
    var defaultToolbars = [
        ['FullScreen','Source','|','Undo','Redo','|',
         ...
         'BlockQuote','|',
         'PastePlain','|',
         'ForeColor','BackColor','InsertOrderedList','InsertUnorderedList','|','Underline',
         'Paragraph','FontFamily','FontSize','|',
         'DirectionalityLtr','DirectionalityRtl','|',
         'JustifyLeft','JustifyCenter','JustifyRight','JustifyJustify','|',
         'Link','Unlink','Image','Spechars','Emoticon','Video','Map', '|',
    ...
    EditorUI.prototype = {
        ...
        initEditorUI: function (){
            ...
            var videoDialog = new baidu.editor.ui.Dialog({
                iframeUrl: '../src/ui/dialogs/video/video.html',
                autoReset: true,
                draggable: true,
                editor: editor,
            ...
            var mapDialog = new baidu.editor.ui.Dialog({
                iframeUrl: '../src/ui/dialogs/map/map.html',
                autoReset: true,
                draggable: true,
                editor: editor,
            ...
            editor.addListener('selectionchange', function (t, evt){
                ...
                var imglink = parent.baidu.editor.dom.domUtils.findParentByTagName(img,"a",true);
                if(imglink != null){
                ...
                link = parent.baidu.editor.dom.domUtils.findParentByTagName(link,"a",true);
                if (link != null) {
        ...
        getHtmlTpl: function (){
            return '<div id="##" class="%%"><div id="##_toolbarbox" class="%%-toolbarbox"><div class="%%-toolbarboxinner">' +
                this.renderToolbarBoxHtml() + '</div></div><div id="##_iframeholder" class="%%-iframeholder"></div>' +
