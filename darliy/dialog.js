function msgbox(msg, fun, text){
	...
	dialogbg.innerHTML = '<div class="bgcolor"></div><div class="dialog"><div class="title" unselectable="on"><div>娑堟伅</div></div><div class="content"></div><div class="text"><input type="text"></div><div class="btns"><button class="ok">纭畾</button><button class="cancel">鍙栨秷</button></div></div>';
